...
QT_MOC_LITERAL(1, 7, 14), // "cameraImgReady"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 8), // "QPixmap*"
QT_MOC_LITERAL(4, 32, 7) // "mpixmap"

    },
    "Camera\0cameraImgReady\0\0QPixmap*\0mpixmap"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cameraImgReady((*reinterpret_cast< QPixmap*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Camera::*_t)(QPixmap * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::cameraImgReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Camera::cameraImgReady(QPixmap * _t1)
{
